...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="image">
                <a href="<?=\yii\helpers\Url::to(['user/profile','id'=>Yii::$app->user->id])?>" class="d-block">
                    <img style="width: 50px;height: 41px" src="/images/kunuzround.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
