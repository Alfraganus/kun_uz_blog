                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= \yii\helpers\Url::to(['content/', 'type' => 'blog']) ?>"
                                   class="nav-link <?= (Yii::$app->controller->id == 'content' && Yii::$app->controller->action->id == 'index' && Yii::$app->request->get('type') == 'blog') ? 'active' : '' ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Blog</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= \yii\helpers\Url::to(['content/', 'type' => 'news']) ?>"
                                   class="nav-link <?= (Yii::$app->controller->id == 'content' && Yii::$app->controller->action->id == 'index' && Yii::$app->request->get('type') == 'news') ? 'active' : '' ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>News</p>
                                </a>
                            </li>
